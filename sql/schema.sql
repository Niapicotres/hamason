...
create table product (discount numeric(5,2) not null, price numeric(5,2) not null, rating integer not null, stock integer not null, family_id bigint not null, id bigint generated by default as identity, description varchar(500) not null, imageUrl varchar(255) not null, primary key (id));
...
alter table if exists product add constraint FKnmuda5pi9mwk61g3l1xu3tqry foreign key (family_id) references FamilyCategory;
